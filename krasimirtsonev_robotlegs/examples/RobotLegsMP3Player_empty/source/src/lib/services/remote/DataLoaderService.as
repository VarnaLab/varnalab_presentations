package lib.services.remote {
	...
	public class DataLoaderService extends Actor {
		...
		private function onDataLoad(e:Event):void {
            ...
            // informing the world that it's done (DataEvent.ON_DATA_LOADED, e.target.data)
            
		}
		private function onDataFiledToLoad(e:IOErrorEvent):void {
            
            // informing the world that something failed (DataEvent.ON_DATA_FAILED_TO_LOAD, e.text)
